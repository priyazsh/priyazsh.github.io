...
desc: Learn how to get started with open source and contribute
date: 21 Aug 2024
...
<img src="/blog/devprofiles-preview.png" alt="DevProfiles website preview" />
...
<img src="/blog/devprofiles-fork.jpeg" alt="Fork repository on GitHub" />

Visit the GitHub repository of DevProfiles and fork it  
Link: <a target="_blank" href="https://github.com/priyanzsh/DevProfiles">github.com/priyanzsh/DevProfiles</a>
...
<img src="/blog/devprofiles-commit.png" alt="Commit changes in GitHub" />

### Submit a Pull request

After commiting changes, you can create a pull request

<img src="/blog/devprofiles-open-pr.png" alt="Open pull request" />

<img src="/blog/devprofiles-submit-pr.png" alt="Submit pull request" />
