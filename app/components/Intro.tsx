    ...
    <div className="mt-2 sm:mt-4">
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        <div className="flex flex-col min-w-0 flex-1">
          <h1 className="font-semibold text-lg sm:text-xl truncate">Priyansh Prajapat</h1>
          <p className="text-gray-500 text-xs sm:text-sm">@priyanzsh</p>
      ...
      <p className="mt-3 sm:mt-4 text-lg md:text-base lg:text-lg text-zinc-300 leading-relaxed">
      ...
      <p className="mt-3 sm:mt-4 text-lg md:text-base lg:text-lg text-zinc-300 leading-relaxed">
        ...
        & some other tooling, also I sometimes write <Link href={"/blog"} className="text-blue-400 hover:text-blue-300 transition-colors">blogs</Link>.
      </p>
    </div>
  );
}
